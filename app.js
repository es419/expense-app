...
function installFloatingKeyboardEditor() {
  ...
  const excluded = new Set(["checkbox","radio","range","color","date","time","datetime-local","month","week","file","button","submit","reset","hidden"]);
  ...
  const positionField = (preFocus = false) => {
    ...
    const set = (name, value) => field.style.setProperty(name, value, "important");
    set("position", "fixed");
